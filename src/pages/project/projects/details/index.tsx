...
import { ProjectDetailsData, ProjectDetailsRouteParams, ProjectDetailsVariables } from "types/project";
...
function ProjectDetais() {
  ...
  const { data, loading, refetch, error } = useQuery<ProjectDetailsData, ProjectDetailsVariables>(GET_PROJECT_DETAILS, {
    variables: {
      id: params.id || "",
    },
  });
